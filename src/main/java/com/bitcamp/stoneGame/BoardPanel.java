...
public class BoardPanel extends JPanel implements MouseListener, MouseMotionListener,
  ...
  public final int startX = 50; //(1920 - boardWidth) / 2;   // 바둑판 시작 X 좌표
  public final int boardHeight = cellSize * (boardSize - 1);
  public final int startY = 50; //(1080 - boardHeight) / 2;  // 바둑판 시작 Y 좌표

  public List<Stone> stones;
  public List<Stone> stonesAction;
  ...
  public void actionPerformed(ActionEvent e) {
    for (Stone stone : stones) {
      stone.move();
      if (stone.getX() < startX ||
          stone.getX() > startX + boardWidth ||
          stone.getY() < startY ||
